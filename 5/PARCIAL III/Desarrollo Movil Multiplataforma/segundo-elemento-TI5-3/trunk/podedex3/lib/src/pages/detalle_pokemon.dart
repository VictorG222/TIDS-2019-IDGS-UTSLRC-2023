...
class DetallePokemon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0.0,
        backgroundColor: pokemon.colorPokemon
      ),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _Habilidades(pokemon),
            _Movimientos(pokemon),
          ],
        ),
      ),
    );
