...
<?php 
header('Location: http://sorteossigsu.uabc.mx/SigsuDatasExplotaition/Miscelaneos/ContactoSitioSorteos.aspx');
 ?>
 <!doctype html>
...
<head>
	...
	<title>Contacto | Sorteos UABC</title>

  <meta name="description" content="Contáctanos, Sorteos UABC se crea con la finalidad de obtener recursos para la UABC.">
...
<?php include("modules/forms/contacto-2018.php") ?>
...
<div class="element-magic" id="section-3">
  ...
  <!-- Final Counter
    ...
    <script>
       ...
       var frmvalidator  = new Validator("myform");
        ...
        frmvalidator.addValidation("nombre","req","<div class='alert alert-danger'><i class='fa fa-exclamation-circle' aria-hidden='true'></i> Nombre Requerido</div>");
        ...
        frmvalidator.addValidation("email","req","<div class='alert alert-danger'><i class='fa fa-exclamation-circle' aria-hidden='true'></i> Email Requerido</div>");
