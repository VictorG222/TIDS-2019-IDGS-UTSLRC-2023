...
<head>
    ...
    <title>Ganadores Sorteo Raspa y Gana | Sorteos UABC</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h1 class="title">Ganadores del Sorteo Raspa y Gana</h1>
            </div>
        </div>
    </div>
</section>
...
<img src="assets/images/mask-white-lg.png" class="img-responsive mask-image-2"> 
    <div class="element-magic" id="section-0">
        <div class="container">
            <?php include("modules/sorteos/ganadores/ganadores-raspa-gana.php") ?>
        </div>
    </div>
</section>
