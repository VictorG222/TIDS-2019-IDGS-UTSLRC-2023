...
<head>
	...
	<title>Ganadores del Primer Sorteo de Colaboradores | Sorteos UABC</title>
...
================================== -->
 <?php 
  ...
  $sorteoPrimer = $sorteo->leer("2"); 
  ?>
<?php include("modules/ganadores/primer-sorteo.php") ?>
