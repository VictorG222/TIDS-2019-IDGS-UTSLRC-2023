...
$magno = new ObjectTable('activar');
$estadoMagno = $magno->leer("2"); 
?>
<?php if ($estadoMagno->estado == "desactivado") : ?>
...
<head>
	...
	<title>Ganadores Sorteo Magno | Sorteos UABC</title>
...
================================== -->
  ...
  $sorteoMagno = $sorteo->leer("1"); 
  ?>

<?php include("modules/ganadores/ganadores-magno.php") ?>
