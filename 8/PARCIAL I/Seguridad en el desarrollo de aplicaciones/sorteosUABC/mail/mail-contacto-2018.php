...
//Mailer
$mail = new PHPMailer();
$mail->setFrom('sorteosuabc@sorteosuabc.com.mx', 'Sorteos UABC');
//$mail->addAddress('contacto@sorteosuabc.mx', 'Sorteos UABC');
$mail->addAddress('jose@guruc.com.mx', 'Sorteos UABC');
