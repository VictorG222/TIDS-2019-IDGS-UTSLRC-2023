...
<head>
    ...
    <title>Primer Sorteo Colaboradores | Sorteos UABC</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Administrar Primer Sorteo Colaboradores
                            </li>
                        </ol>
                    </div>
                </div>
