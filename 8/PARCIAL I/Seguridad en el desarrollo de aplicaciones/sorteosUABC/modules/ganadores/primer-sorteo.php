...
<section class="ganadores-section">
	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<!-- <h1 class="title">Primer Sorteo de Colaboradores</h1> -->

			<img src="<?php echo $url_website; ?>docs/<?php echo $sorteoPrimer->imagen; ?>" class="img-responsive image-ganadores-header">
  ...
  $objPHPExcel = $objReader->load("docs/".$sorteoPrimer->archivoexcel);
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="descarga-pdf-content">
	            ...
	            <a href="<?php echo $url_website; ?>docs/<?php echo $sorteoPrimer->archivopdf; ?>" class="btn btn-yellow btn-round" role="button" target="_blank">Descarga PDF <i class="fa fa-file-pdf-o" aria-hidden="true"></i></a> 
		...
		<div class="row">
			...
			<p class="text padding-all">
				<?php echo  nl2br($sorteoPrimer->texto); ?>
			</p>
