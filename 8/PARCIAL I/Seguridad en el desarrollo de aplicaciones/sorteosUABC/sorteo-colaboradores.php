...
<head>
  ...
  <title>Sorteo de Colaboradores | Sorteos UABC</title>
  <meta name="description" content="Apoya la educación superior en Baja California y participa también en los 3 Sorteos de Colaboradores">
...
<!-- SORTEO MAGNO
================================== -->
<?php //include("modules/sorteos/hero-sorteo-colaboradores.php") ?>
<?php include("modules/sorteos/tabs-sorteo-colaboradores.php") ?>
