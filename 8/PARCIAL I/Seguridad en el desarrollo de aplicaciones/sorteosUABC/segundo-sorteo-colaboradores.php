...
<head>
	...
	<title>Ganadores del Segundo Sorteo de Colaboradores | Sorteos UABC</title>
...
<?php 
  ...
  $sorteoSegundo = $sorteo->leer("3"); 
  ?>
<?php include("modules/ganadores/segundo-sorteo.php") ?>
